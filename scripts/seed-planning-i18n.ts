...
async function main() {
  ...
  const rows = [
    ...
    // New activity from the board, library sync, templates
    { key: "planBoard.newActivity", cs: "Nová aktivita", en: "New activity" },
    { key: "planBoard.newActivityShort", cs: "+ Nová", en: "+ New" },
    { key: "planBoard.createActivity", cs: "Vytvořit", en: "Create" },
    { key: "planBoard.errorNameRequired", cs: "Vyplňte název aktivity.", en: "Enter the activity name." },
    { key: "planBoard.errorNewNowhere", cs: "Uložte aktivitu do knihovny, nebo vyberte místo v plánu.", en: "Save the activity to the library or pick a place in the plan." },
    { key: "planBoard.libraryTitle", cs: "Knihovna aktivit", en: "Activity library" },
    { key: "planBoard.saveToLibrary", cs: "Uložit do knihovny této akce", en: "Save to this event's library" },
    { key: "planBoard.placeInPlan", cs: "Umístit do plánu", en: "Place in the plan" },
    { key: "planBoard.placeNotNow", cs: "Zatím neumisťovat", en: "Don't place yet" },
    { key: "planBoard.applyToOthers", cs: "Použít i na ostatních {count} výskytů v plánu", en: "Also apply to the other {count} occurrences in the plan" },
    { key: "planBoard.updateInLibrary", cs: "Aktualizovat v knihovně", en: "Update in library" },
    { key: "planBoard.saveAsNewToLibrary", cs: "Uložit do knihovny jako novou", en: "Save to library as new" },
    { key: "planBoard.updateInLibraryHint", cs: "Knihovna převezme název, délku, kategorie, vedoucího, místo a popis z tohoto bloku.", en: "The library takes this block's name, duration, categories, leader, location and description." },
    { key: "planBoard.saveAsNewHint", cs: "Vytvoří v knihovně novou aktivitu podle tohoto bloku a propojí je.", en: "Creates a new library activity from this block and links them." },
    { key: "planActivities.status.template", cs: "Ze šablony", en: "From template" },
    { key: "planActivities.status.modified", cs: "Upraveno", en: "Modified" },
    { key: "planActivities.status.local", cs: "Jen v této akci", en: "This event only" },
    { key: "planActivities.status.templateHint", cs: "Shoduje se se základní knihovnou.", en: "Matches the base library." },
    { key: "planActivities.status.modifiedHint", cs: "Liší se od šablony, ze které vznikla.", en: "Differs from the template it came from." },
    { key: "planActivities.status.localHint", cs: "V základní knihovně není.", en: "Not in the base library." },
    { key: "planActivities.saveTemplate", cs: "↑ Do šablon", en: "↑ To templates" },
    { key: "planActivities.updateTemplate", cs: "↑ Aktualizovat šablonu", en: "↑ Update template" },
    { key: "planActivities.selectedToTemplates", cs: "Uložit vybrané do šablon ({count})", en: "Save selected to templates ({count})" },
    { key: "planActivities.templatesSaved", cs: "Šablony: {created} nových, {updated} aktualizovaných.", en: "Templates: {created} new, {updated} updated." },
    { key: "planLists.leaderColor", cs: "Barva (v exportu)", en: "Color (in exports)" },

    // Google Sheet export design (settings)
    { key: "sheetStyle.title", cs: "Plánování – vzhled exportu do Google tabulky (vaše osobní nastavení; použije se při vašem exportu):", en: "Planning – Google Sheet export design (personal; used when you export):" },
    { key: "sheetStyle.titleBg", cs: "Nadpis", en: "Title" },
    { key: "sheetStyle.headerBg", cs: "Záhlaví", en: "Header" },
    { key: "sheetStyle.headerText", cs: "Text záhlaví", en: "Header text" },
    { key: "sheetStyle.zebraColor", cs: "Pruhy", en: "Stripes" },
    { key: "sheetStyle.fontSize", cs: "Velikost písma", en: "Font size" },
    { key: "sheetStyle.zebra", cs: "Střídat barvu bloků", en: "Striped blocks" },
    { key: "sheetStyle.mergeDays", cs: "Sloučit buňky dne", en: "Merge day cells" },
    { key: "sheetStyle.mergeTimes", cs: "Sloučit čas souběžných aktivit", en: "Merge times of parallel activities" },
    { key: "sheetStyle.colorOrganization", cs: "Barvit organizační bloky (kategorie mimo analýzu)", en: "Color organisational blocks (categories outside the analysis)" },
    { key: "sheetStyle.colorLeaders", cs: "Barvit buňky vedoucích", en: "Color leader cells" },
    { key: "sheetStyle.showCategoryColumns", cs: "Sloupce hlavních kategorií (minuty)", en: "Main category columns (minutes)" },
    { key: "sheetStyle.showDescription", cs: "Popis", en: "Description" },
    { key: "sheetStyle.showLocation", cs: "Místo", en: "Location" },
    { key: "sheetStyle.showGroups", cs: "Skupiny", en: "Groups" },
    { key: "sheetStyle.showSecondary", cs: "Vedlejší kategorie", en: "Secondary categories" },
